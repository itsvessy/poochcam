...
private let thumbnailQueue = DispatchQueue(label: "com.vessy.poochcam.thumbnail")
...
class ResourceUsage {
    ...
    private func updateMemoryUsage() {
        ...
        var count = mach_msg_type_number_t(MemoryLayout<task_vm_info_data_t>.size / MemoryLayout<integer_t>
            .size)
