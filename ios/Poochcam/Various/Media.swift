...
final class Media: NSObject, @unchecked Sendable {
    ...
    private var srtStreamNew: SrtStreamPoochcam?
    ...
    private var srtImplementation: SettingsStreamSrtImplementation = .poochcam
                      ...
                      limitAdaptiveBitrateByTransportBitrate: Bool)
    {
        ...
        case .srt:
            ...
            case .poochcam:
                srtStreamNew = SrtStreamPoochcam(
                    processor: processor,
...
extension Media: SrtStreamPoochcamDelegate {
