...
extension Model {
    private func handleSettingsUrlsDefaultStreams(settings: PoochcamSettingsUrl,
    ...
    private func handleSettingsUrlsDefaultQuickButtons(settings: PoochcamSettingsUrl) {
    ...
    private func handleSettingsUrlsDefaultWebBrowser(settings: PoochcamSettingsUrl) {
    ...
    private func handleSettingsUrlsDefaultRemoteControl(settings: PoochcamSettingsUrl) {
    ...
    private func handleSettingsUrlsDefault(settings: PoochcamSettingsUrl) {
    ...
    private func handleSettingsUrlsDefaultStreamCollisions(settings: PoochcamSettingsUrl,
    ...
    private func findCollidingStreamNames(streams: [PoochcamSettingsUrlStream]) -> Set<String> {
    ...
    private func handleSettingsUrlWithConfirmation(url: URL) -> String? {
        ...
        let settings: PoochcamSettingsUrl
        do {
            settings = try PoochcamSettingsUrl.fromString(query: query)
        } catch {
