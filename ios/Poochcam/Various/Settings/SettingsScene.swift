...
class SettingsWidgetBrowser: Codable, ObservableObject {
    ...
    @Published var poochcamAccess: Bool = false
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case fps
        case styleSheet
        // Preserve the key used by existing settings files.
        case poochcamAccess = "moblinAccess"
        case speechToText
        case localOnly
    }
    ...
    func encode(to encoder: any Encoder) throws {
        ...
        try container.encode(.poochcamAccess, poochcamAccess)
    ...
    required init(from decoder: any Decoder) throws {
        ...
        poochcamAccess = container.decode(.poochcamAccess, Bool.self, false)
...
class SettingsWidgetScoreboardPlayer: Codable, Identifiable, ObservableObject, Named {
    static let baseName = String(localized: "🇸🇪 Poochcam")
    var id: UUID = .init()
