...
class SettingsDebug: Codable, ObservableObject {
    ...
    @Published var enhancedPoochcamSrt: Bool = false
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case enhancedPoochcamSrt = "enhancedMoblinSrt"
    ...
    func encode(to encoder: any Encoder) throws {
        ...
        try container.encode(.enhancedPoochcamSrt, enhancedPoochcamSrt)
    ...
    required init(from decoder: any Decoder) throws {
        ...
        enhancedPoochcamSrt = container.decode(.enhancedPoochcamSrt, Bool.self, false)
