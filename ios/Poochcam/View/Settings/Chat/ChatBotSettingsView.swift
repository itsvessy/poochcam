...
private struct GimbalPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: String(localized: "!poochcam gimbal preset <name>"),
                permissions: permissions
            )
        } footer: {
...
private struct AlertPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: String(localized: "!poochcam alert <name>"),
                permissions: permissions
            )
        } footer: {
...
private struct FaxPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: String(localized: "!poochcam fax <url>"),
                permissions: permissions
            )
        } footer: {
...
private struct SnapshotPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: String(localized: "!poochcam snapshot <optional message>"),
                permissions: permissions
            )
        } footer: {
            Text("Take snapshot.")
...
private struct ReactionPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: String(localized: "!poochcam reaction <reaction>"),
                permissions: permissions
            )
        } footer: {
...
private struct FilterPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: String(localized: "!poochcam filter <filter> <on/off>"),
                permissions: permissions
            )
        } footer: {
            VStack(alignment: .leading) {
...
private struct ScenePermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: String(localized: "!poochcam scene <name>"),
                permissions: permissions
            )
        } footer: {
...
private struct StreamPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: "!poochcam stream ...",
                permissions: permissions
            )
        } footer: {
            VStack(alignment: .leading) {
                Text(String("!poochcam stream start"))
                Text("Start the stream.")
                Text("")
                Text(String("!poochcam stream stop"))
                Text("Stop the stream.")
                Text("")
                Text("!poochcam stream title <title>")
                Text("Set stream title.")
                Text("")
                Text("!poochcam stream category <category name>")
...
private struct WidgetPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: String(localized: "!poochcam widget ..."),
                permissions: permissions
            )
        } footer: {
            VStack(alignment: .leading) {
                Text("!poochcam widget <name> enable")
                Text("Enable given widget.")
                Text("")
                Text("!poochcam widget <name> disable")
                Text("Disable given widget.")
                Text("")
                Text("!poochcam widget <name> wheelofluck options <option 1> <option 2> ...")
                Text("Set options for given wheel of luck.")
                Text("")
                Text("!poochcam widget <name> wheelofluck spin")
                Text("Spin given wheel of luck.")
                Text("")
                Text("!poochcam widget <name> timer <number> add <seconds>")
...
private struct LocationPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: "!poochcam location ...",
                permissions: permissions
            )
        } footer: {
            VStack(alignment: .leading) {
                Text(String("!poochcam location data reset"))
                Text("Resets distances, average speed and slope.")
                Text("")
                Text(String("!poochcam location data split"))
...
private struct TtsSayPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: "!poochcam tts/say ...",
                permissions: permissions
            )
        } footer: {
            VStack(alignment: .leading) {
                Text(String("!poochcam tts on"))
                Text("Turn on chat text to speech.")
                Text("")
                Text(String("!poochcam tts off"))
                Text("Turn off chat text to speech.")
                Text("")
                Text("!poochcam say <message>")
    ...
    var body: some View {
        Section {
            NavigationLink {
                ...
                .navigationTitle("!poochcam ai ask <question>")
            } label: {
                Text("!poochcam ai ask <question>")
            }
        } footer: {
...
private struct TwitchPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: "!poochcam twitch ...",
                permissions: permissions
            )
        } footer: {
            VStack(alignment: .leading) {
                Text(String("!poochcam twitch raid <channel>"))
...
private struct MuteUnmutePermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: "!poochcam mute/unmute",
                permissions: permissions
            )
        } footer: {
            VStack(alignment: .leading) {
                Text(String("!poochcam mute"))
                Text("Mute audio.")
                Text("")
                Text(String("!poochcam unmute"))
                Text("Unmute audio.")
            }
        }
    }
...
private struct TeslaPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: "!poochcam tesla ...",
                permissions: permissions
            )
        } footer: {
            VStack(alignment: .leading) {
                Text(String("!poochcam tesla trunk open"))
                Text("Open the trunk.")
                Text("")
                Text(String("!poochcam tesla trunk close"))
                Text("Close the trunk.")
                Text("")
                Text(String("!poochcam tesla media next"))
                Text("Next track.")
                Text("")
                Text(String("!poochcam tesla media previous"))
                Text("Previous track.")
                Text("")
                Text(String("!poochcam tesla media toggle-playback"))
...
private struct MacroPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: String(localized: "!poochcam macro <run/cancel> <name>"),
                permissions: permissions
            )
        } footer: {
            VStack(alignment: .leading) {
                Text("!poochcam macro run <name>")
                Text("Run given macro.")
                Text("")
                Text("!poochcam macro cancel <name>")
...
private struct SendPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: String(localized: "!poochcam send <message>"),
                permissions: permissions
            )
        } footer: {
            VStack(alignment: .leading) {
                Text("!poochcam send <message>")
...
private struct AppleMusicPermissionsSettingsView: View {
    ...
    var body: some View {
        Section {
            PermissionsSettingsView(
                title: "!poochcam music ...",
                permissions: permissions
            )
        } footer: {
            VStack(alignment: .leading) {
                Text("!poochcam music add <song>")
                Text("Add given song to the queue.")
                Text("<song> is either a share link or text search.")
                Text("")
                Text(String("!poochcam music play"))
                Text("Play.")
                Text("")
                Text(String("!poochcam music pause"))
                Text("Pause.")
                Text("")
                Text(String("!poochcam music next"))
                Text("Next song.")
                Text("")
                Text(String("!poochcam music previous"))
                Text("Previous song.")
                Text("")
                Text(String("!poochcam music status"))
                Text("Show status.")
            }
        }
    }
...
private struct ChatBotAliasSettingsView: View {
    ...
    private func onAliasChange(value: String) -> String? {
        ...
        guard !value.starts(with: "!poochcam") else {
            return String(localized: "The alias must not start with !poochcam.")
        }
    ...
    private func onReplacementChange(value: String) -> String? {
        ...
        guard value.starts(with: "!poochcam") else {
            return String(localized: "The replacement must start with !poochcam.")
        }
        guard value.split(separator: " ").count > 1 else {
