        ...
        GeometryReader { metrics in
            Form {
                ...
                Section {
                    ...
                    Poochcam's RTMP server on this device. Select \(String(localized: "Custom")) to \
...
private struct GoProLaunchLiveStream: View {
    ...
    private func deleteLaunchLiveStream(at offsets: IndexSet) {
    ...
    var body: some View {
        Section {
            List {
                ...
                .onDelete(perform: deleteLaunchLiveStream)
            }
            CreateButtonView {
...
private struct GoProWifiCredentials: View {
    ...
    private func deleteWifiCredentials(at offsets: IndexSet) {
    ...
    var body: some View {
        Section {
            List {
                ...
                .onDelete(perform: deleteWifiCredentials)
            }
            CreateButtonView {
...
private struct GoProRtmpUrls: View {
    ...
    private func deleteRtmpUrl(at offsets: IndexSet) {
    ...
    var body: some View {
        Section {
            List {
                ...
                .onDelete(perform: deleteRtmpUrl)
            }
            CreateButtonView {
