...
struct DeepLinkCreatorSettingsView: View {
    ...
    private func createDeepLinkStream(stream: DeepLinkCreatorStream) -> PoochcamSettingsUrlStream {
        let newStream = PoochcamSettingsUrlStream(name: stream.name, url: stream.url)
        if stream.selected {
    ...
    private func updateDeepLinkStreams(settings: PoochcamSettingsUrl) {
    ...
    private func updateDeepLinkQuickButtons(settings: PoochcamSettingsUrl) {
        ...
        for button in deepLinkCreator.quickButtons.buttons where button.enabled {
            ...
            let newButton = PoochcamSettingsButton(type: button.type)
    ...
    private func updateDeepLinkWebBrowser(settings: PoochcamSettingsUrl) {
