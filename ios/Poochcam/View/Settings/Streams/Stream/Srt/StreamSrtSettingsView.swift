    ...
    var body: some View {
        Form {
            Section {
                ...
                if srt.implementation == .poochcam, srt.latency < 1000 {
                    Text("""
                    ⚠️ The \"Poochcam\" implementation does not perform well with low latency. \
            ...
            Section {
                ...
                Text("""
                \"Official\" uses the widely supported libSRT (version 1.5.3) and \"Poochcam\" uses a \
