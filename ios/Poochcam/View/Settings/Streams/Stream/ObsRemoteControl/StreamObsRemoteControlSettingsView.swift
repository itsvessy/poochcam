...
struct StreamObsRemoteControlSettingsInnerView: View {
    ...
    var body: some View {
        ...
        Section {
            ...
            Text("""
            Poochcam will periodically try to switch to the BRB scene if the stream is \
        ...
        if model.database.showAllSettings {
            Section {
                ...
                Text("""
                Poochcam will switch to the BRB scene configured above when the current scene's \
                SRT(LA) or RTMP video source is disconnected. Typically enable when using Poochcam \
        ...
        Section {
            ...
            Text("The name of the Source in OBS that receives the stream from Poochcam.")
        }
        if model.database.showAllSettings {
            Section {
